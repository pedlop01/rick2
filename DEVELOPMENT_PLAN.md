...
| 44 | Migrar Camelot Warriors al Rick2 Engine | Alta | 35, 39-43 | Pendiente | Primero se convierte y valida una fase vertical completa; después las cuatro fases, assets, scripts, secuencias, diálogos y final funcionan en el editor y runtime nuevos. El proyecto antiguo permanece como referencia y fixtures, y el nuevo Camelot no depende de parsers ni del runtime Allegro 4. |
