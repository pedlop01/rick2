...
| 39 | Formalizar Camelot Warriors como proyecto de validación | Alta | 34 | Pendiente | Se documenta una matriz de equivalencias entre ambos motores y se elige una escena vertical de Camelot con transformación, combate, script, cámara y presentación; cada carencia se clasifica como capacidad genérica, behavior del juego o conversión de datos, sin introducir excepciones por nombre de juego. |
