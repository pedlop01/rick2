...
| 28 | Asegurar accesibilidad, atajos y rendimiento del editor | Media | 20, 25, 26 | Pendiente | Atajos y foco no interfieren con formularios; las herramientas principales pueden usarse con teclado, incluyendo `Espacio + arrastrar` como alternativa al botón central para desplazar el lienzo; mapas grandes mantienen interacción fluida y las operaciones costosas informan progreso o se ejecutan fuera del hilo de UI. |
...
| 32 | Pulir la visualización e interacción de entidades y relaciones | Media | 23, 28 | Pendiente | Filtros, leyenda, colores, selección, solapamientos y densidad de guías hacen comprensibles las relaciones del nivel real; crear y localizar entidades resulta natural con ratón, touchpad y teclado. |
